...
function adicionarOuAlterar(e){
	...
	var p = {
		...
		sex : document.getElementById('sltSex').selectedIndex,
...
function doUpdate(idRow){	
	...
	var txtName = document.getElementById('txtName'),
	    ...
	    stdMale = document.getElementById('sltMale'),
	    stdFemale = document.getElementById('sltFemale');
